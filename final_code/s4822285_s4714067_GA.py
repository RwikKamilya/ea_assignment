...
def s4822285_s7414067_GA(problem: ioh.Problem, budget: int, seed: int, params: GAParams) -> RunSummary:
...
def _run_suite(fid: int, dim: int, budget: int, runs: int, base_seed: int, data_root: Path, params: GAParams) -> None:
    ...
    algo_name = "s4822285_s7414067_GA"
    ...
    for r in range(runs):
        seed = base_seed + r
        problem.reset()
        rs = s4822285_s7414067_GA(problem, budget=budget, seed=seed, params=params)
        rs.run_index = r
